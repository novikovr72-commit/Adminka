...
public class OrganizationController {
    ...
    @GetMapping("/organization/{organUnitId}/descendants")
    public ResponseEntity<Map<String, Object>> organizationDescendants(
        @PathVariable("organUnitId") String organUnitIdRaw
    ) {
        return organizationService.listOrganizationDescendants(organUnitIdRaw);
    }

    @PostMapping("/organization/{parentOrganUnitId}/subdivisions")
    public ResponseEntity<Map<String, Object>> createSubdivision(
        @PathVariable("parentOrganUnitId") String parentOrganUnitIdRaw,
        @RequestBody(required = false) Map<String, Object> rawBody
    ) {
        return organizationService.createSubdivision(parentOrganUnitIdRaw, rawBody);
    }

    @PatchMapping("/organization/{organUnitId}/parent")
    public ResponseEntity<Map<String, Object>> organizationUpdateParent(
        @PathVariable("organUnitId") String organUnitIdRaw,
        @RequestBody(required = false) Map<String, Object> rawBody
    ) {
        return organizationService.updateOrganizationParent(organUnitIdRaw, rawBody);
    }
}
