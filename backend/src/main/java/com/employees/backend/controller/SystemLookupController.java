...
public class SystemLookupController {
    ...
    public ResponseEntity<Map<String, Object>> listOrganizations(
        ...
        @RequestParam(name = "relation_organ_lookup", required = false) String relationOrganLookupSnakeRaw,
        @RequestParam(name = "relationOrganLookup", required = false) String relationOrganLookupCamelRaw
    ) {
        return organizationService.listOrganizations(
            showShortCodeSnakeRaw,
            showShortCodeCamelRaw,
            organNameSnakeRaw,
            organNameCamelRaw,
            relationOrganLookupSnakeRaw,
            relationOrganLookupCamelRaw
        );
    }
